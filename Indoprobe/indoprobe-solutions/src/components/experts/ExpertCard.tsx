    ...
    <>
      ...
      >
        <div className="relative">
          ...
          <span className="absolute left-4 top-4 rounded-full bg-navy-950/70 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.15em] text-gold-300 backdrop-blur-sm">
            Expert {String(index + 1).padStart(2, "0")}
          </span>
        </div>
